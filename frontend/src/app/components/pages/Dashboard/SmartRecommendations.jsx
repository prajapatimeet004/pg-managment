  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetContent
          side="right"
          className="w-[420px] md:w-[520px] max-w-[95vw] h-full p-0 border-none bg-white/90 dark:bg-black/90 backdrop-blur-2xl rounded-l-[2.5rem] flex flex-col shadow-2xl z-50 outline-none focus:outline-none focus-visible:outline-none"
        >
          {/* Custom Close Button */}
          ...
          <div className="p-8 relative z-10 flex flex-col gap-6 overflow-y-auto h-full custom-scrollbar flex-1 min-h-0">
            {/* Header */}
            ...
            <div className="flex flex-col gap-4 flex-1 min-h-0">
              ...
              <div className="bg-white/50 dark:bg-white/5 border border-white/50 dark:border-white/10 rounded-[2rem] p-6 flex-1 min-h-[120px] max-h-[250px] overflow-y-auto custom-scrollbar">
                {isAiLoading ? (
              ...
              <div className="pt-2 flex-shrink-0">
                <Link to="/ai-assistant" className="w-full" onClick={() => setIsOpen(false)}>
