...
export function MainLayout() {
  ...
  const NavLinks = ({ mobile = false, onClose }) => (
    <nav className={cn("space-y-1", mobile && "pt-4")}>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black font-sans antialiased text-gray-900 dark:text-gray-100">
      {/* Mobile Glass Header */}
      ...
      <div className="lg:flex">
        {/* Desktop Sidebar */}
        <aside className="hidden lg:flex flex-col w-72 bg-white dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 min-h-screen sticky top-0">
        ...
        <main className="flex-1 min-h-screen">
          ...
          <div className="hidden lg:flex items-center justify-end px-8 py-4 bg-white/50 dark:bg-black/50 backdrop-blur-sm border-b border-gray-100 dark:border-gray-900 sticky top-0 z-30">
