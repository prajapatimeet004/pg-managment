...
import { type Tenant, type RentTransaction } from "../../lib/mockData";
...
export function RentCollection() {
  ...
  const handleGenerateReceipt = (tenant: any) => {
          ...
          <Card key={i} className="border-none shadow-sm hover:shadow-md transition-shadow group overflow-hidden">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div className={`w-12 h-12 rounded-2xl bg-${item.color}-50 dark:bg-${item.color}-900/20 flex items-center justify-center text-${item.color}-600 group-hover:rotate-6 transition-transform`}>
